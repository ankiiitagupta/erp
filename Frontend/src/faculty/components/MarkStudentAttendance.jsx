...
//           <span>240 Total Students</span>
//           <span className="icon">👨‍🎓</span>
//         </div>
//         <div className="card present-today">
//           <span>230 Present Today</span>
//           <span className="icon">✅</span>
//         </div>
//         <div className="card absent-today">
//           <span>10 Absent Today</span>
//           <span className="icon">❌</span>
//         </div>
...
//         // Calculate present and absent students count
...
//     // Update the present and absent students counts dynamically
